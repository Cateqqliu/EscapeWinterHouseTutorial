...
### 3. 互動音效 (SFX)：使用高品質免版稅音效庫
對於短促、明確的互動聲音（例如：拿取馬克杯的碰撞聲、翻開書本的紙張聲、點擊按鈕的音效），比起用 AI 生成，直接去專業音效庫挖寶會精準且快速非常多！
* **強力推薦：** [Pixabay Sound Effects](https://pixabay.com/zh/sound-effects/)
* **尋寶技巧：** 這是一個完全免費且無版權爭議的神級素材庫。只要輸入關鍵字（例如 `page turn`, `glass clink`, `knife sound`），就能找到大量專業級的環境互動音效。

<img src="images/免費音效網站.png" width="800">

現在基礎的美術和音樂都準備好了，接下來就要開啟 Unity 並匯入專案，前往**第一章**開始一起做整個專案的佈局吧！
